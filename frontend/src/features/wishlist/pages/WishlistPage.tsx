      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-100 dark:border-gray-800">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
            ...
            <span className="text-sm font-semibold px-2.5 py-1 rounded-full bg-rose-50 dark:bg-rose-950/50 text-rose-600 dark:text-rose-400 border border-rose-100 dark:border-rose-900/50">
              {items.length} {items.length === 1 ? "course" : "courses"}
            </span>
          </h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Courses you have saved to learn in the future</p>
        </div>
          ...
          {items.map(({ _id, course }) => (
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden bg-gray-100 dark:bg-gray-800">
                ...
                />
                <span className="absolute top-3 left-3 px-2.5 py-1 rounded-full text-xs font-semibold bg-white/90 dark:bg-gray-900/90 backdrop-blur-xs text-gray-800 dark:text-gray-200 shadow-xs capitalize">
                  {course.level}
                </span>
                ...
                <button
                  ...
                  className="absolute top-3 right-3 p-2 rounded-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-xs text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/50 hover:text-rose-600 shadow-xs transition-colors"
                >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">By {course.instructor?.name || "Instructor"}</p>
