    ...
    if (announcements.length === 0) {
        return (
            <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-sm">No announcements yet from the instructor.</p>
            </div>
        );
    }
                ...
                >
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-gray-700 text-sm whitespace-pre-line leading-relaxed">{ann.body}</p>
                        </div>
                    </div>
                </div>
            ))}
