...
function Analytics() {
  ...
  return (
    <div className="space-y-8">
        ...
        {courses.length > 0 && (
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="bg-white border border-gray-300 rounded-xl px-4 py-2 text-sm text-gray-800 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-xs"
            >
      ...
      {courses.length === 0 ? (
        <div className="text-center py-20 bg-white border border-gray-200 rounded-3xl p-8 max-w-lg mx-auto">
          <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl">
            📊
          </div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">No Course Analytics Yet</h2>
        ...
        <>
              ...
              <div className="space-y-4">
                {lessonDropOff.map((les) => {
                  ...
                  return (
                    <div
                      key={les.lessonId}
                      className="bg-gray-50/70 border border-gray-200/70 rounded-xl p-4 transition-all hover:bg-gray-50"
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
                        <div className="flex items-center gap-2">
                          <span className="w-6 h-6 rounded-lg bg-gray-200 text-gray-700 text-xs font-bold flex items-center justify-center">
                            {les.order}
                          </span>
                          <span className="font-semibold text-sm text-gray-900">
                            {les.title}
                          </span>
                          <span className="text-[11px] uppercase font-bold text-gray-400 bg-white border border-gray-200 px-2 py-0.5 rounded-md">
                            {les.type}
                          </span>
                          {isHighDropOff && (
                        ...
                        <div className="flex items-center gap-4 text-xs text-gray-600">
                          <span>
                            ...
                            <span className="font-bold text-emerald-600">{les.completionRate}%</span>)
                          </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-xs flex flex-col justify-between">
              <div>
                ...
                {quizPerformance.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {quizPerformance.map((q) => (
                      <div
                        key={q.lessonId}
                        className="bg-gray-50 border border-gray-100 rounded-xl p-4 flex items-center justify-between gap-4"
                      >
                  ...
                  <div className="space-y-3">
                    {mostActiveStudents.map((student, rank) => {
                      ...
                      return (
                        <div
                          key={student.id}
                          className="bg-gray-50 border border-gray-100 rounded-xl p-3 sm:p-4 flex items-center justify-between gap-3 hover:bg-gray-100/70 transition-colors"
                        >
