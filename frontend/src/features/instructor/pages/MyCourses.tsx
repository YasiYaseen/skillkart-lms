        ...
        <div>
            <div className="flex items-center justify-between mb-8">
                ...
                <Link
                    ...
                    className="bg-blue-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors flex items-center gap-2"
                >
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="border-b border-gray-100 bg-gray-50">
                            <th className="text-left py-3.5 px-6 text-gray-500 font-medium">Course</th>
                            <th className="text-left py-3.5 px-6 text-gray-500 font-medium">Level</th>
                            <th className="text-left py-3.5 px-6 text-gray-500 font-medium">Earnings</th>
                            <th className="text-left py-3.5 px-6 text-gray-500 font-medium">Students</th>
                            <th className="text-left py-3.5 px-6 text-gray-500 font-medium">Status</th>
                            <th className="text-right py-3.5 px-6 text-gray-500 font-medium">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {courses.map((course) => (
                            <tr key={course.id} className="border-b border-gray-50 hover:bg-gray-50/60 transition-colors">
                                {/* Course info */}
                                <td className="py-4 px-6">
                                    <div className="flex items-center gap-3">
                                        <img
                                            ...
                                            alt={course.title}
                                            className="w-14 h-9 rounded-md object-cover flex-shrink-0 border border-gray-100"
                                        />
                                        <span className="text-gray-800 font-medium line-clamp-2 max-w-xs">{course.title}</span>
                                    </div>
                                </td>
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        <button
                                            ...
                                            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors disabled:opacity-50 ${
                                                course.status === 'published' ? 'bg-blue-600' : 'bg-gray-300'
                                            }`}
                                        >
                            ...
                            <tr>
                                <td colSpan={6} className="py-16 text-center text-gray-400">
                                    <div className="flex flex-col items-center gap-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1} className="text-gray-300">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                                        </svg>
                                        <p>No courses yet. <Link to="/instructor/create-course" className="text-blue-600 hover:underline">Create your first course</Link></p>
                                    </div>
                                </td>
                            </tr>
                        )}
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            ...
                            disabled={!!deletingId}
                            className="flex-1 bg-gray-100 text-gray-700 py-2.5 rounded-lg font-semibold text-sm hover:bg-gray-200 disabled:opacity-50 transition-colors"
                        >
                            Cancel
                        </button>
                    </div>
