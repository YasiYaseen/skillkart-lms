...
function Announcements() {
    ...
    if (loadingCourses) {
        return <div className="text-gray-500 py-10">Loading your courses...</div>;
    }
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6">
                        ...
                        <form onSubmit={handleCreate} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={submitting}
                                className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-5 py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                        ...
                        {loadingAnnouncements ? (
                            ...
                            <div className="divide-y divide-gray-100">
                                {announcements.map((ann) => (
                                    <div
                                        key={ann._id}
                                        className="px-6 py-5 flex items-start justify-between gap-4 hover:bg-gray-50 transition-colors"
                                    >
