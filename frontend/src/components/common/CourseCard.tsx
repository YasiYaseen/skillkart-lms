 ...
 */
export function CourseCard({ course, className = '', showWishlist = true, isEnrolled }: CourseCardProps) {
    const {
        id,
        title,
        instructor,
    ...
    const isAlreadyEnrolled = isEnrolled ?? course.isEnrolled ?? false;
        ...
        <div className="relative group/card flex flex-col h-full">
            ...
            >
                ...
                <div className="absolute top-2.5 right-2.5 z-10 flex items-center gap-1.5">
                    {showWishlist && id && !isAlreadyEnrolled && (
                ...
                <div className="p-4 sm:p-5 flex flex-col flex-1">
                    ...
                    {/* Footer: Rating, Price & Quick Cart / Enrolled Action */}
