            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 py-1.5 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
                    ...
                    <div className="py-1 text-xs">
                        ...
                        {/* Instructor Teaching Links */}
                        {user.role === 'instructor' && (
                            <div className="pb-1 mb-1 border-b border-gray-100 dark:border-gray-800">
                                ...
                                <Link
                                    to="/instructor"
                                    onClick={() => setIsOpen(false)}
                                    className="flex items-center gap-2.5 px-4 py-2 text-blue-600 dark:text-blue-400 font-semibold hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-colors"
                                >
                            ...
                            <>
                                ...
                                {user.role === 'student' && (
                                    <Link
                                        ...
                                        onClick={() => setIsOpen(false)}
                                        className="flex items-center gap-2.5 px-4 py-2 text-indigo-600 dark:text-indigo-400 font-medium hover:bg-indigo-50 dark:hover:bg-indigo-950/40 transition-colors"
                                    >
