    ...
    <>
      ...
      <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="container mx-auto flex items-center justify-between h-16 md:h-18 px-4 sm:px-6 lg:px-8">
          ...
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2.5 text-xl font-bold text-slate-900 dark:text-white shrink-0 group">
            <span className="w-9 h-9 bg-blue-600 rounded-full flex items-center justify-center shadow-xs group-hover:scale-105 transition-transform">
              <GraduationCapIcon className="w-5 h-5 text-white" />
            </span>
            <span className="tracking-tight">SkillKart</span>
          </Link>
